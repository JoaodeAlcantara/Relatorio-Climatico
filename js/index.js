import { CreactTable, getCidade, getEstado, innerHTML } from "./script.js"
...
document.querySelector('#cidade').addEventListener('change', async function () {
    ...
    try {
        ...
        document.querySelector('#erro').classList.remove('hyde');
        document.querySelector('.table').classList.add('hyde')
        erro.innerHTML = 'Erro ao buscar', error.statusText
    }
